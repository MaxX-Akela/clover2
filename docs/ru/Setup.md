...
5. Выберите последовательный порт полётного контроллера.
6. QGroundControl предложит перевести контроллер в режим загрузчика, отключите USB-кабель и подключите его снова.
...
9. В выпадающем меню выберите *Custom firmware file...*.
...
10. Нажмите *OK* и выберите скачанный файл прошивки.
